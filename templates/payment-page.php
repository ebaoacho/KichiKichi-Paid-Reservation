...
<div id="kkpay-payment-wrap" class="kkpay-wrap">
    ...
    <div id="kkpay-payment-section">
        <p id="kkpay-payment-loading" class="kkpay-notice">Loading payment page... / 決済ページを読み込んでいます...</p>
    ...
    <div id="kkpay-success-section" style="display:none;" class="kkpay-success-box">
        ...
        <p class="kkpay-success-email-notice kkpay-i18n" id="lbl-email-sent">確認メールをお送りしました。</p>
    </div>
